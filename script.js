...
const manifestoData = [
    {v: "🛠️ FAZER", t: "O antídoto contra a inércia. Agir gera autoeficácia."},
    {v: "🌱 QUERER", t: "Combustível do propósito. Desejar empreender em si mesmo."},
    {v: "🎈 CURTIR", t: "O prazer como imperativo de saúde. Sem culpa."},
    {v: "📚 CONHECER", t: "Juventude da mente. A curiosidade mantém o cérebro jovem."},
    {v: "💬 CONVERSAR", t: "Terapia do vínculo. O diálogo protege contra o isolamento."},
    {v: "❤️ CUIDAR", t: "Manutenção do templo. Corpo, pets, plantas e memória."},
    {v: "🤝 COMPARTILHAR", t: "Transcendência. Oferecer afeto é sabedoria coletiva."},
    {v: "➕ OUTROS", t: "Gestão prática. A organização que garante a paz mental."}
];
...
// FUNÇÃO ROBUSTA DE RENDERIZAÇÃO
...
function changeTab(t) {
    ...
    // Sempre tenta renderizar quando troca
    if (t === 'info') renderManifesto();
}
...
window.onload = () => {
    ...
    // RENDERIZAÇÃO IMEDIATA DO MANIFESTO PARA EVITAR TELA BRANCA
    render();
    renderManifesto();
